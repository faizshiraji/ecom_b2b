                ...
                <label class="aiz-megabox d-block mb-3">
                    ...
                    <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                        <span class="d-block fw-400 fs-14">
                            @if($payment_method->id==14)Digital Payment @else {{ ucfirst(translate($payment_method->name)) }}@endif
                           
                            </span>
                        <span class="rounded-1 h-40px overflow-hidden">
                            <img src=" @if($payment_method->id==14) https://rates.fm/static/content/thumbs/388x218/1/04/kxphlz-e6a2ce471812a3c20e197434137d5041.jpg @else {{ static_asset('assets/img/cards/'.$payment_method->name.'.png') }} @endif"
                            class="img-fit h-100">
                        </span>
                    </span>
                </label>

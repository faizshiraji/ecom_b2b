            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.htm"><img src="assets/imgs/theme/deshi-shad-logo.png" alt="logo"></a>
                    </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a >Who We Are <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a >Products <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="fish.html">Fish</a></li>
                                            <li><a href="snacks.html">Snacks</a></li>
                                            <li><a href="dryfoods.html">Dry Foods</a></li>
                                            <li><a href="grain.html">Grain</a></li>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu font-heading">
                            ...
                            <li class="menu-item-has-children">
                                <a href="shop-grid-right">Who We Are</a>
                                <ul class="dropdown">
                                    <li><a href="vision-mission-values.html">Vision , Mission , & Values</a></li>
                                    <li><a href="about.html">About</a></li>
                                </ul>
                             ...
                             <li class="menu-item-has-children">
                                <a href="shop-grid-right">Products</a>
                                <ul class="dropdown">
                                         <li><a href="fish.html">Fish</a></li>
                                            <li><a href="snacks.html">Snacks</a></li>
                                            <li><a href="dryfoods.html">Dry Foods</a></li>

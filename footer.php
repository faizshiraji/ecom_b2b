                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="logo mb-30">
                                <a href="index.htm" class="mb-15"><img src="assets/imgs/theme/deshi-shad-logo.png" alt="logo"></a>
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span>info@deshishad.com</span></li>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2025, <strong class="text-brand">Developed by Gen iTech</strong><br>All rights reserved <strong class="text-brand">Deshi Shad</strong></p>
                </div>
